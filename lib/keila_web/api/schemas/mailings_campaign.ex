defmodule KeilaWeb.Api.Schemas.MailingsCampaign do
  @properties %{
    ...
    subject: %{
      type: :string,
      example: "💻 Our Computer Sceince Book is Now Available!",
      required: true
    },
    text_body: %{
      type: :string,
      example: """
      Hey {{ contact.first_name }}, are you excited for our Computer Sceince Book?
    ...
    data: %{
      ...
      example: %{
        "books" => [
          %{"title" => "Computer Sceince Book", "url" => "books.books/computersciencebook"},
          %{"title" => "Human Resource Book", "url" => "books.books/humanresourcebook"}
        ]
      }
    },
    settings: %{
